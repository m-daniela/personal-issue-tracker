export const dbCollectionNames = {
    ...
    taskPath: (projectId, categoryId, taskId) => ["projects", projectId, "categories", categoryId, "tasks", taskId], 
    tasksPath: (projectId, categoryId) => ["projects", projectId, "categories", categoryId, "tasks"], 
